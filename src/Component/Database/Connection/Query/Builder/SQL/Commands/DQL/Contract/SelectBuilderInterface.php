<?php
namespace Laventure\Component\Database\Connection\Query\Builder\SQL\Commands\DQL\Contract;

use Laventure\Component\Database\Connection\Query\Builder\SQL\Commands\DQL\Query;
